...
doErrorPlacement = (label, element) => {
...
jQuery.validator.addMethod("validTitle", function (value, element, params) {
    return this.optional(element) || jQuery.validator.methods.customRangeLength.call(this, value, element, params);
});

jQuery.validator.addMethod("validDescription", function (value, element, params) {
    return this.optional(element) || jQuery.validator.methods.customRangeLength.call(this, value, element, params);
});

jQuery.validator.addMethod("validVersion", function (value, element, params) {
    return this.optional(element) || jQuery.validator.methods.customRangeLength.call(this, value, element, params);
});

jQuery.validator.addMethod("validComment", function (value, element, params) {
    return this.optional(element) || jQuery.validator.methods.customRangeLength.call(this, value, element, params);
});
...
addValidationForNameAndDescription = () => {
    ...
    $('#add-form').validate({
        rules: {
            name: {
                customRequired: $('#name-valid-title').text(),
                validName: [MIN_NAME_LENGTH, MAX_NAME_LENGTH]
            },
            description: {
    ...
    $('#edit-form').validate({
        rules: {
            editName: {
                customRequired: $('#edit-name-valid-title').text(),
                validName: [MIN_NAME_LENGTH, MAX_NAME_LENGTH]
            },
            editDescription: {
    ...
    $.extend($.validator.messages, {
        ...
        validName: $.i18n("product.name.validation", MIN_NAME_LENGTH, MAX_NAME_LENGTH),
