...
Eureka is an internal issue tracking and management system, originally built as a capstone project. Teams register **products**, break each product into **subsystems** and **release versions**, and then log, triage, assign and resolve **issues** against them — similar in spirit to Jira, scoped down to the essentials. It supports role-based access (Users, Developers, Managers, Admins), localized UI in three languages, email notifications, and a set of security features (hashed passwords, HttpOnly session cookies, throttled login attempts) covered below with screenshots.
...
*The sign-in screen, available in English, Russian and Armenian.*

<p align="center">
  <img src="docs/images/login-throttle-hy.png" width="60%"/>
</p>

*After too many failed attempts, login is temporarily throttled — shown here in Armenian.*
